  ...
  return (
    <div className=" w-[800px] ">
      ...
      >
        ...
        />
        <label className="h-10 text-sm "> back </label>
        <CustomTiptap
          editor={editor}
          className=" h-full w-full border-neutral-800/70 bg-neutral-100 p-10 shadow-inner hover:cursor-text active:border-none"
          editable
        />
        <button
          className="mx-auto rounded-md  bg-black p-5 text-white"
          type="submit"
        >
          {" "}
          SUBMIT{" "}
...
const CustomTiptap = ({
  ...
  let parsedContent;
  try {
    if (content) parsedContent = JSON.parse(content) as JSONContent;
  } catch (e) {
