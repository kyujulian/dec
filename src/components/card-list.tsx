  ...
  return (
    <>
      ...
      <div className="flex gap-5">
        <button className='w-10 h-10 bg-black text-white' onClick={incrementIndex} > inc </button>
        <button className='w-10 h-10 bg-black text-white' onClick={decrementIndex} > dec </button>
      </div>
    </>
  )
}
