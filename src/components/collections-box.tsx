...
function Example({ collections, setCollection }: { collections: Collection[], setCollection: Dispatch<SetStateAction<string | undefined>> }) {
  ...
  return (
    <div className="bg-blue-400 w-full h-[80vh]">
      <ul ref={parent} className="w-full h-full grid-cols-4 grid-rows-3 grid gap-4">
        {collections.map((collection: Collection, index) => (
          <li className=" hover:cursor-pointer rounded-md bg-neutral-100 border-[1px] border-neutral-400 shadow-md dark:border-neutral-500 dark:bg-neutral-700 " key={index}>
            <div className="w-full h-[200px] relative"><Image
